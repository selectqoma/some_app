...
docker run\
    ...
    bash -c "cd /home/kpv/catkin_ws && catkin build && source /home/kpv/catkin_ws/devel/setup.bash && catkin run_tests --no-deps smelter_deployment_tests -DPYTHON_EXECUTABLE=/usr/bin/python3"
